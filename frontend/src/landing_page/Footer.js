  ...
  return (
    ...
    <div className="container border-top mt-5 " >
      <div className="row mt-5">
        <div className="col">
          <img src="media/images/TradeXlogo.jpg" style={{ width: "50%" }} />
          <p>
        ...
        <div className="col" >
          ...
          <br />
          <a href="" style={{textDecoration:"none"}}>TradeX.tech</a>
          <br />
          <a href="" style={{textDecoration:"none"}}> Open source</a>
          <br />
          <a href="" style={{textDecoration:"none"}}> Press & media</a>
          <br />
          <a href="" style={{textDecoration:"none"}}> TradeX Cares (CSR)</a>
          <br />
        </div>
        <div className="col">
          <p>Support</p>
      ...
      <p>
        ...
        no.: INZ000031633 CDSL/NSDL: Depository services through TradeX Broking
        Ltd. – SEBI Registration no.: IN-DP-431-2019 Commodity Trading through
        TradeX Commodities Pvt. Ltd. MCX: 46025; NSE-50001 – SEBI Registration
        ...
        pertaining to securities broking please write to complaints@TradeX.com,
        for DP related to dp@TradeX.com. Please ensure you carefully read the
      ...
      <p>
        ...
        part of TradeX and offering such services, please create a ticket here.
      </p>
      </div>
    </div>
    </footer>
